...
export const about = {
  lead: "“마케팅을 잘하게 만드는 것이 아니라,\n사용자 없이도 굴러가게 만드는 것.”",
  paragraphs: [
    "Java·Spring Boot 기반의 백엔드를 중심으로, 데이터 분석과 생성형 AI, 그리고 VR·콘텐츠 제작까지 하나의 흐름으로 엮는 것을 좋아합니다.",
    "기술을 넓게 펼치기보다, 사용자의 실제 행동 흐름을 따라 ‘왜 이 구조인가’를 끝까지 고민하는 편입니다. 졸업작품 PULSE는 그 고민을 가장 깊게 담은 결과물입니다.",
    "졸업을 앞두고, 이제는 견고한 백엔드 시스템 위에서 사람의 경험을 설계하는 개발자로 한 걸음 더 나아가려 합니다.",
  ],
};
